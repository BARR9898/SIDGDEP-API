...
const generateReportMensualytiesValidations = [
...
export {createAgentsValidations,getAgentValidations,getAgentsValidations,generateReportMensualytiesValidations,deleteAgentValidations};